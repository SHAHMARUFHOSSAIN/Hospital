...
<div class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-white mb-8">Create Page</h1>
        ...
        <form action="{{ route('admin.pages.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="content" rows="8" class="w-full px-4 py-2 bg-gray-900 border border-gray-600 rounded-lg text-white"></textarea>
                </div>
